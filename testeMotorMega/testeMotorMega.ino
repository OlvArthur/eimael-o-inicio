...
//  Serial.println(estado_inicial1);
//  Serial.println(estado_inicial2);
//  Serial.println(estado_inicial3);
//  delay(2000);
  for (int i=0; i<2; i++)
  {
...
//  Serial.print("Linha Frente E: ");
//  Serial.println(estado_atual);
//  delay(250);
  if((estado_inicial1 - estado_atual) > 100){
    return true;
  }
  else{
    return false;
...
//  Serial.print("Linha Frente D: ");
//  Serial.println(estado_atual);
//  delay(250);
  if((estado_inicial2 - estado_atual) > 100){
    return true;
  }
  else{
    return false;
...
//  Serial.print("Linha de Trás: ");
//  Serial.println(estado_atual);
//  delay(250);
  if((estado_inicial3 - estado_atual) > 100){
    return true;
  }
  else{
    return false;
